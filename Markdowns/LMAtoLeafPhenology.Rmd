...
We then apply a fit linear mixed-effects model. By using the lmer function in the lme4 package, we are able to fit the model to the selected data. 
```{r mixedeffects}
...
###Logistic Regression
We create estimates of the top 5 fossil families and 
```{r}
...
Lastly, we create two plots, the first 
