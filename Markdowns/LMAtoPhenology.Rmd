...
ggplot1<-ggplot(final_WSLA_DF1, aes(x = log_LMA, y = scrubbed_family)) + geom_density_ridges(scale = 0.9)
ggplot2<-ggplot(final_WSLA_DF2,aes(x = log_LMA, y = scrubbed_family)) + geom_density_ridges(scale = 0.9)
